...
<p>Utilized Keras to train the neural networks for image processing</p>
]

const CHARLESSCHWAB = [
    <p>Developed application feature, in an Agile/Scrum environment, for changing the password of a Schwab account</p>,
    <p>Led in the development a Risk-Based Authentication feature to verify a user attempting to change their password</p>,
    <p>Utilized full-stack knowledge through use of Angular 6, Jasmine, Java, and MongoDB and unit testing in Karma</p>
]

const ANTHROPOLOGY = [
    <p>Developed a full-stack platform using the Flask framework that connects anthropologists around the world</p>,
